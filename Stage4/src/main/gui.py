...
class MembersMenu(tk.Frame):
    ...
    def add_member(self):
        ...
        tk.Label(top, text="Enter, respectively: Name, Email, Phone Number, Address, Age, Membership Start Date, Membership End Date", 
                 bg=DARK_BG, fg=TEXT_COLOR, font=FONT).pack(pady=5)

        entries = [tk.Entry(top, bg=ENTRY_BG, fg=TEXT_COLOR, font=FONT, insertbackground=TEXT_COLOR) for _ in range(7)]
...
class ClassesMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        """
        tk.Button(inner, text="Show All Classes", width=40, bg=BUTTON_BG, fg=TEXT_COLOR, font=FONT,
        ...
        # Implementing CRUD commands. ------------------------------------------------------------------------------------------------
        tk.Button(inner, text="Add New Class", width=40, bg=BUTTON_BG, fg=TEXT_COLOR, font=FONT,
                  command=self.add_class).pack(side=tk.RIGHT, padx=2)
        tk.Button(inner, text="Edit Existing Class", width=40, bg=BUTTON_BG, fg=TEXT_COLOR, font=FONT,
                  command=self.edit_class).pack(side=tk.RIGHT, padx=2)
        tk.Button(inner, text="Delete Existing Class", width=40, bg=BUTTON_BG, fg=TEXT_COLOR, font=FONT,
                  command=self.delete_class).pack(side=tk.RIGHT, padx=2)
